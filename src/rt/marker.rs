...
#[cfg(all(feature = "std", any(target_arch = "wasm32", target_arch = "wasm64"), panic = "unwind"))]
...
#[cfg(not(all(feature = "std", any(target_arch = "wasm32", target_arch = "wasm64"), panic = "unwind")))]
