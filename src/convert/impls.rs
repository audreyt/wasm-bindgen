...
// On wasm32, usize/isize are 32-bit and use u32/i32 ABI with f64 option sentinel.
// On wasm64, usize/isize are 64-bit and must use u64/i64 ABI (type_wasm_native).
...
// ErasableGeneric and Promising are generated by type_wasm_native_f64_option
// but not by type_wasm_native, so add them for wasm64 usize/isize.
#[cfg(target_pointer_width = "64")]
