(module $int128_reftest.wasm
  ...
  (type (;5;) (func (param i32 i64 i64) (result i32 i64 i64)))
  (import "./reference_test_bg.js" "__wbg___wbindgen_throw_6ddd609b62940d55" (func (;0;) (type 1)))
  ...
  (func $"echo_i128 multivalue shim" (;2;) (type 3) (param i64 i64) (result i64 i64))
  (func $"echo_option_i128 multivalue shim" (;3;) (type 5) (param i32 i64 i64) (result i32 i64 i64))
  (func $"echo_option_u128 multivalue shim" (;4;) (type 5) (param i32 i64 i64) (result i32 i64 i64))
  (func $"echo_u128 multivalue shim" (;5;) (type 3) (param i64 i64) (result i64 i64))
  (func $"throw_i128 multivalue shim" (;6;) (type 4) (result i64 i64 i32 i32))
  (func $__externref_table_dealloc (;7;) (type 0) (param i32))
