(module $wasm_export_types_reftest.wasm
  ...
  (import "./reference_test_bg.js" "__wbindgen_init_externref_table" (func (;1;) (type 6)))
  ...
  (func $"example externref shim multivalue shim" (;2;) (type 4) (param i32 i64 externref i32 i32) (result i32 i32))
  (func $"example_128 multivalue shim" (;3;) (type 5) (param i64 i64) (result i32 i64 i64))
  (func $__wbindgen_malloc (;4;) (type 2) (param i32 i32) (result i32))
  (func $__wbindgen_realloc (;5;) (type 0) (param i32 i32 i32 i32) (result i32))
  (func $__wbindgen_free (;6;) (type 1) (param i32 i32 i32))
