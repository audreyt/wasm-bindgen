...
#[cfg(all(any(target_arch = "wasm32", target_arch = "wasm64"), feature = "std", panic = "unwind"))]
...
#[cfg(not(all(any(target_arch = "wasm32", target_arch = "wasm64"), feature = "std", panic = "unwind")))]
